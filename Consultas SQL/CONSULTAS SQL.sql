...
-- Asignar categorías basadas en el límite de crédito
...
-- Actualizar con la diferencia en días
UPDATE Staging.dbo.Staging_pedido
...
INSERT INTO DataMarFinal.dbo.DataMart_Dim_Cliente (ID_cliente, Nombre_cliente, Ciudad, País, Limite_credito)
...
INSERT INTO DataMarFinal.dbo.DataMart_Dim_Tiempo (Fecha, Año, Mes, Día)
